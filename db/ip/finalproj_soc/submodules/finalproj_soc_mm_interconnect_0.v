...
module finalproj_soc_mm_interconnect_0 (
	...
	wire   [13:0] cmd_demux_001_src5_channel;                                                         // cmd_demux_001:src5_channel -> cmd_mux_012:sink1_channel
	...
	wire  [105:0] cmd_demux_001_src6_data;                                                            // cmd_demux_001:src6_data -> cmd_mux_013:sink1_data
	...
	wire   [13:0] rsp_demux_012_src1_channel;                                                         // rsp_demux_012:src1_channel -> rsp_mux_001:sink5_channel
	...
	wire  [105:0] rsp_demux_013_src1_data;                                                            // rsp_demux_013:src1_data -> rsp_mux_001:sink6_data
	...
	finalproj_soc_mm_interconnect_0_router_002 router_003 (
	...
	finalproj_soc_mm_interconnect_0_router_002 router_004 (
	...
	finalproj_soc_mm_interconnect_0_router_002 router_005 (
	...
	finalproj_soc_mm_interconnect_0_router_006 router_006 (
	...
	finalproj_soc_mm_interconnect_0_router_007 router_007 (
	...
	finalproj_soc_mm_interconnect_0_router_007 router_008 (
	...
	finalproj_soc_mm_interconnect_0_router_007 router_009 (
	...
	finalproj_soc_mm_interconnect_0_router_007 router_010 (
	...
	finalproj_soc_mm_interconnect_0_router_007 router_011 (
	...
	finalproj_soc_mm_interconnect_0_router_007 router_012 (
	...
	finalproj_soc_mm_interconnect_0_router_007 router_013 (
	...
	finalproj_soc_mm_interconnect_0_router_002 router_015 (
	...
	finalproj_soc_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	finalproj_soc_mm_interconnect_0_cmd_mux cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	finalproj_soc_mm_interconnect_0_cmd_mux cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	finalproj_soc_mm_interconnect_0_cmd_mux cmd_mux_004 (
		.clk                 (sdram_pll_c0_clk),                        //       clk.clk
		.reset               (sdram_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	finalproj_soc_mm_interconnect_0_cmd_mux_005 cmd_mux_005 (
		.clk                 (clk_0_clk_clk),                             //       clk.clk
		.reset               (keycode_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	finalproj_soc_mm_interconnect_0_cmd_mux_005 cmd_mux_006 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	finalproj_soc_mm_interconnect_0_cmd_mux_005 cmd_mux_007 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	finalproj_soc_mm_interconnect_0_cmd_mux_005 cmd_mux_008 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	finalproj_soc_mm_interconnect_0_cmd_mux_005 cmd_mux_009 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	finalproj_soc_mm_interconnect_0_cmd_mux_005 cmd_mux_010 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	finalproj_soc_mm_interconnect_0_cmd_mux_005 cmd_mux_011 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	finalproj_soc_mm_interconnect_0_cmd_mux cmd_mux_013 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	finalproj_soc_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	finalproj_soc_mm_interconnect_0_rsp_demux rsp_demux_002 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	finalproj_soc_mm_interconnect_0_rsp_demux rsp_demux_003 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	finalproj_soc_mm_interconnect_0_rsp_demux rsp_demux_004 (
		.clk                (sdram_pll_c0_clk),                             //       clk.clk
		.reset              (sdram_reset_reset_bridge_in_reset_reset),      // clk_reset.reset
	...
	finalproj_soc_mm_interconnect_0_rsp_demux_005 rsp_demux_005 (
		.clk                (clk_0_clk_clk),                             //       clk.clk
		.reset              (keycode_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	finalproj_soc_mm_interconnect_0_rsp_demux_005 rsp_demux_006 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	finalproj_soc_mm_interconnect_0_rsp_demux_005 rsp_demux_007 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	finalproj_soc_mm_interconnect_0_rsp_demux_005 rsp_demux_008 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	finalproj_soc_mm_interconnect_0_rsp_demux_005 rsp_demux_009 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	finalproj_soc_mm_interconnect_0_rsp_demux_005 rsp_demux_010 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	finalproj_soc_mm_interconnect_0_rsp_demux_005 rsp_demux_011 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	finalproj_soc_mm_interconnect_0_rsp_demux rsp_demux_013 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
