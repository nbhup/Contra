...
(
    ...
    localparam PAD5 = log2ceil(64'h8001168 - 64'h8001160); 
    localparam PAD6 = log2ceil(64'h8001170 - 64'h8001168); 
    // -------------------------------------------------------
    ...
    // ( 0x8001168 .. 0x8001170 )
    if ( {address[RG:PAD6],{PAD6{1'b0}}} == 28'h8001168  && read_transaction  ) begin
