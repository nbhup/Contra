...
#set_input_delay -max -clock MAX10_CLK1_50 5.9 [get_ports altera_reserved*]
#set_input_delay -min -clock MAX10_CLK1_50 3.0 [get_ports altera_reserved*]
#
#set_input_delay -max -clock MAX10_CLK1_50 5.9 [get_ports SW*]
#set_input_delay -min -clock MAX10_CLK1_50 3.0 [get_ports SW*]
#
#set_input_delay -max -clock MAX10_CLK1_50 5.9 [get_ports KEY0]
#set_input_delay -min -clock MAX10_CLK1_50 3.0 [get_ports KEY0]
#
#set_input_delay -max -clock MAX10_CLK1_50 5.9 [get_ports KEY1]
#set_input_delay -min -clock MAX10_CLK1_50 3.0 [get_ports KEY1]
...
#set_output_delay -max -clock MAX10_CLK1_50 1.6 [get_ports LEDR*]
#set_output_delay -min -clock MAX10_CLK1_50 -0.9 [get_ports LEDR*]
#
